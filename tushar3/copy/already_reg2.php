...
<div class="big1">
<div class="bigm"><p><b>You are already registered with this Email. Cant Connect to facebook!!</b><br/>Click below to login</p>
</div>

<center><button class="bigs"  style=" width:15%" onclick="relocate('login1.php')">LogIn</button></center>
