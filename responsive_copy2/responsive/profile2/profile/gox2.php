...
$result1 = mysqli_query($con,'SELECT id,full_name FROM members WHERE full_name LIKE "%'.$search_string.'%" limit 4');
...
$result = mysqli_query($con,'SELECT * FROM members WHERE full_name LIKE "%'.$search_string.'%" AND limit 1');
while($row=mysqli_fetch_array($result))
{
$i++;
$x=$row['full_name'];
